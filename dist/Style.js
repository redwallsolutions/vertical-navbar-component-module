...
var applyToNavbarWhenTottalyShown = css(_templateObject2());
var applyToNavbarWhenPartiallyShown = css(_templateObject3());
var VerticalNavbarStyled = styled.div(_templateObject4(), function (props) {
...
export var NavbarContainer = styled.div(_templateObject5());
var NavbarTogglerStyled = styled.div(_templateObject6(), function (props) {
  return theming(props).color;
}, function (props) {
  return props.currentMode === MODES.hidden ? .7 : 0;
});
NavbarTogglerStyled.defaultProps = defaultProps;
export { NavbarTogglerStyled };
export var NavbarTogglerContainer = styled.div(_templateObject7());
var NavbarTogglerIndicator = styled.span(_templateObject8(), function (props) {
  return theming(props).color;
}, function (props) {
  return props.currentMode === MODES.hidden ? .7 : 0;
}, function (props) {
...
var NavbarItemStyled = styled.div(_templateObject9(), function (props) {
  return props.isActive ? theming(props).color : Color(theming(props).contrast(props)).darken(.7).string();
}, function (props) {
...
export var NavbarItemIconContainer = styled.div(_templateObject10(), function (props) {
  return props.currentMode === MODES.totallyShown ? '30%' : '100%';
}, function (props) {
  return props.currentMode === MODES.totallyShown ? 'flex-end' : 'center';
});
export var NavbarItemTextContainer = styled.div(_templateObject11());
export var NavbarItemTitle = styled.h1(_templateObject12());
export var NavbarItemSubtitle = styled.h3(_templateObject13());
var NavbarItemBadge = styled.span(_templateObject14(), function (props) {
  return theming(props).color;
}, function (props) {
...
export var NavbarHeaderItem = styled.header(_templateObject15(), function (props) {
  return props.currentMode === MODES.totallyShown ? '30vh' : '20vh';
});
var NavbarHeaderItemImage = styled.img(_templateObject16());
NavbarHeaderItemImage.defaultProps = defaultProps;
export { NavbarHeaderItemImage };
var NavbarHeaderItemSubtitle = styled.h4(_templateObject17(), function (props) {
...
export var Content = styled.div(_templateObject18());